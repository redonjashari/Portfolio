    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/redonjashari/contix" target="_blank" rel="noreferrer"><img src={mock10} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/GPT-2-Refined" target="_blank" rel="noreferrer"><img src={mock09} className="zoom" alt="thumbnail" width="92%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/HazardDetectionUnit" target="_blank" rel="noreferrer"><img src={mock08} className="zoom" alt="thumbnail" width="100%" height={400}/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/ShopLane" target="_blank" rel="noreferrer"><img src={mock07} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/ticketmeister" target="_blank" rel="noreferrer"><img src={mock06} className="zoom" alt="thumbnail" width="100%" height={400}/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/2-bit-Branch-Predictor" target="_blank" rel="noreferrer"><img src={mock05} className="zoom" alt="thumbnail" width="100%" height={400}/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/Restaurant-Website" target="_blank" rel="noreferrer"><img src={mock04} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/redonjashari/AsmCompiler" target="_blank" rel="noreferrer"><img src={mock03} className="zoom" alt="thumbnail" width="100%" height={375}/></a>
